...
export default async function RankingsPage() {
  const ranked = await getRankings(30);
  const top = ranked[0];
  ...
  return (
    <div className="mx-auto max-w-3xl px-3 py-6 sm:px-5">
      ...
      {ranked.length === 0 ? (
        <p className="py-16 text-center text-[var(--color-ink-muted)]">
          Pas encore assez de données — le bot alimente le site.
        </p>
      ) : (
            ...
            return (
              ...
              >
                ...
                <MediaImg
                  ...
                  width={48}
                  height={48}
                  className="h-12 w-12 rounded-full object-cover bg-[var(--color-surface-2)]"
                />
